...
// Include the sandbox SVM model exported in the sandbox
#include "svm_model_sandbox.h"
...
void setup() {
  ...
  Serial.println("\n2. SVM Model sandbox Loaded (Physiological Features)");
...
void loop() {
  ...
  float mean_ir_ratio = 0.397674f;
  float std_ir_ratio  = 0.178739f;
  float mean_red_ratio = 0.174604f;
  float std_red_ratio  = 0.077628f;
  float mean_rise_time_ms = 202.667609f;
  float std_rise_time_ms  = 30.137623f;
  float mean_heart_rate = 77.316304f;
  float std_heart_rate  = 8.360008f;
