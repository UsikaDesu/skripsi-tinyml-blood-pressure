...
dataset_path = os.path.join(os.path.dirname(__file__), 'extracted_features_sandbox.csv')
...
plt.title('Kurva Belajar (Learning Curve) - Klasifikasi Hipertensi sandbox', fontsize=14, fontweight='bold', pad=15)
