...
data_path = os.path.join("dataset_sandbox", "extracted_features_sandbox.csv")
...
try:
    ...
    print("Pastikan Anda menjalankan skrip ini dari dalam folder raw_data_pipeline_sandbox")
    exit()
...
plt.title('Heatmap Korelasi antara Fitur dan Status Hipertensi (sandbox)')
plt.tight_layout()
plt.savefig('korelasi_heatmap_bp_class_sandbox.png')
print("Heatmap korelasi telah disimpan sebagai 'korelasi_heatmap_bp_class_sandbox.png'")
plt.show()
...
plt.tight_layout()
plt.savefig('boxplot_distribusi_fitur_ht_sandbox.png')
print("Boxplot telah disimpan sebagai 'boxplot_distribusi_fitur_ht_sandbox.png'")
plt.show()
