...
MODEL_OUTPUT_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'esp32_bp_inference_svm_sandbox', 'svm_model_sandbox.h'))

def main():
    print("=" * 70)
    print("OPTIMASI MODEL sandbox: HYPERPARAMETER TUNING (SVM TinyML)")
    print("=" * 70)
