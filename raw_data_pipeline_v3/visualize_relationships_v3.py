...
data_path = os.path.join("dataset", "extracted_features_v3.csv")
...
try:
    ...
    print("Pastikan Anda menjalankan skrip ini dari dalam folder raw_data_pipeline_v3")
    exit()
...
plt.title('Heatmap Korelasi antara Fitur dan Status Hipertensi (V3)')
plt.tight_layout()
plt.savefig('korelasi_heatmap_bp_class_v3.png')
print("Heatmap korelasi telah disimpan sebagai 'korelasi_heatmap_bp_class_v3.png'")
plt.show()
...
plt.tight_layout()
plt.savefig('boxplot_distribusi_fitur_ht_v3.png')
print("Boxplot telah disimpan sebagai 'boxplot_distribusi_fitur_ht_v3.png'")
plt.show()
