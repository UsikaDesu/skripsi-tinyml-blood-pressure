/*
 * ESP32 Blood Pressure Classification V2 (Physiological v3)
 *
...
// Include the V2 Random Forest model exported in the v3
#include "rf_model_v3.h"
...
void setup() {
  ...
  Serial.println("\n2. RF Model V2 Loaded (Physiological Features)");
...
void loop() {
  ...
  // Feature array order in V3 RF: [ir_ratio, red_ratio, heart_rate, crest_time_ratio]
  float features[4] = {irRatio, redRatio, heartRate, crestTimeRatio};
