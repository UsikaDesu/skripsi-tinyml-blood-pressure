...
def extract_features(df):
    ...
    y = np.column_stack([y_systolic, y_diastolic])
    ...
    print(f"\nTarget statistics:")
    print(f"  Systolic BP:  mean={y_systolic.mean():.1f}, std={y_systolic.std():.1f}")
    print(f"  Diastolic BP: mean={y_diastolic.mean():.1f}, std={y_diastolic.std():.1f}")
