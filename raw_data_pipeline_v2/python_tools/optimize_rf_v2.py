"""
Train RF V2 with optimizations:
...
DATA_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'dataset_v2', 'extracted_features_v2.csv'))
MODEL_OUTPUT_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'esp32_bp_inference_rf_v2', 'rf_model_v2.h'))



def main():
    print("=" * 70)
    print("OPTIMASI MODEL V2: HYPERPARAMETER TUNING (Hanya 4 Fitur Fisiologis)")
    print("=" * 70)
    ...
    feature_sets = {
        'V2 Only (4 fitur)': ['ir_ratio', 'red_ratio', 'rise_time_ms', 'heart_rate'],
    }
    
    X_base = df[['ir_ratio', 'red_ratio', 'rise_time_ms', 'heart_rate']].values
